...
#ifndef V8_CODEGEN_SPARC64_MACRO_ASSEMBLER_SPARC64_H_
#define V8_CODEGEN_SPARC64_MACRO_ASSEMBLER_SPARC64_H_
...
#include "src/codegen/shared-sparc64/macro-assembler-shared-sparc64.h"
...
class V8_EXPORT_PRIVATE MacroAssembler
 ...
 public:
  ...
  void I16x16ExtMul(YMMRegister dst, XMMRegister src1, XMMRegister src2,
                    YMMRegister scratch, bool is_signed);
#define MACRO_ASM_SPARC64_IEXTADDPAIRWISE_LIST(V) \
...
#define DECLARE_IEXTADDPAIRWISE(ExtAddPairwiseOp) \
  ...
  MACRO_ASM_SPARC64_IEXTADDPAIRWISE_LIST(DECLARE_IEXTADDPAIRWISE)
#undef DECLARE_IEXTADDPAIRWISE
#undef MACRO_ASM_SPARC64_IEXTADDPAIRWISE_LIST
...
// Splat
#define MACRO_ASM_SPARC64_ISPLAT_LIST(V) \
...
#define DECLARE_ISPLAT(name, suffix, instr_mov) \
  ...
  MACRO_ASM_SPARC64_ISPLAT_LIST(DECLARE_ISPLAT)
...
#undef DECLARE_ISPLAT
  ...
  void EnterFrame(StackFrame::Type type, bool load_constant_pool_pointer_reg) {
    // Out-of-line constant pool not implemented on sparc64.
    UNREACHABLE();
  }
...
#endif  // V8_CODEGEN_SPARC64_MACRO_ASSEMBLER_SPARC64_H_
