...
// SSE/AVX instruction families mirrored for the SPARC64 backend.
//
// The SPARC64 assembler/macro-assembler shares x64 helper templates that
// expand these lists into method declarations. Keep this header architecture-
// local (instead of including the x64 header directly) so SPARC-specific
// additions can stay separate.
...
// SPARCV9 VIS instruction families that are specific to this backend.
