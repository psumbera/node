...
#ifndef V8_CODEGEN_SHARED_SPARC64_MACRO_ASSEMBLER_SHARED_SPARC64_H_
#define V8_CODEGEN_SHARED_SPARC64_MACRO_ASSEMBLER_SHARED_SPARC64_H_
...
// functions that can be shared across ia32 and sparc64 without any template
...
// Common base class template shared by ia32 and sparc64 MacroAssembler. This uses
...
// defined in ia32 or sparc64 specific MacroAssembler from within this template
// class, via Impl.
//
...
class V8_EXPORT_PRIVATE SharedMacroAssembler : public SharedMacroAssemblerBase {
 ...
 public:
  void Abspd(XMMRegister dst, XMMRegister src, Register tmp) {
    FloatUnop(dst, src, tmp,
              static_cast<FloatInstruction>(&SharedMacroAssemblerBase::Andps),
  ...
  void Negpd(XMMRegister dst, XMMRegister src, Register tmp) {
    FloatUnop(dst, src, tmp,
              static_cast<FloatInstruction>(&SharedMacroAssemblerBase::Xorps),
...
#endif  // V8_CODEGEN_SHARED_SPARC64_MACRO_ASSEMBLER_SHARED_SPARC64_H_
